...
const Footer = () => {
  return (
    <div className="mt-20 px-4 xs:px-12 sm:px-20 md:px-[100px] text-theme-gray flex flex-col xs:flex-row justify-center xs:justify-between items-center gap-2 xs:gap-0 pb-5">
